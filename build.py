...
D = [
    ...
    dict(
        ...
        edu=[
            ...
            ('2533', 'ปรัชญาดุษฎีบัณฑิต (Ph.D. สัตวแพทย์) · มหาวิทยาลัยอะซาบุ ประเทศญี่ปุ่น'),
        ],
        jobs=[
